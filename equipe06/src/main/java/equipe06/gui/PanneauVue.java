...
import equipe06.Domaine.PanneauDTO;  // Import de PanneauDTO pour récupérer les informations du panneau
import javax.swing.*;
import java.awt.*;
...
public class PanneauVue extends JPanel {
    ...
    public PanneauVue() {
        ...
        // Récupérer le panneau via le contrôleur
        Controleur controleur = Controleur.getInstance();
        PanneauDTO panneauDTO = controleur.getPanneau();

        // Conversion des dimensions du panneau récupérées via le contrôleur
